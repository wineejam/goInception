...
var ErrorsChinese = map[ErrorCode]string{
	...
	ER_INCEPTION_EMPTY_QUERY:               "Inception error, Query was empty.",
	ER_PK_COLS_NOT_INT:                     "主键列 '%s' 必须使用int或bigint类型且有无符号unsigned属性，如:bigint unsigned(表'%s'.'%s').",
...
func (e ErrorCode) String() string {
	...
	case ErrMaxBlobCount:
		return "er_max_blob_count"
	case ErrMaxJsonCount:
		return "er_max_json_count"
	case ErrMaxCharVarcharLength:
		return "er_max_char_varcher_length"
	case ER_ERROR_LAST:
